    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            if (choice == Choice.ORIGINAL) {
                ...
                System.out.println(p.bulkIndex("search-elastic-test-yyco5dncwicwd2nufqhakzek2e.us-east-1.es.amazonaws.com", 443, "https", "rfps2", "rfp2", p.getHighlightedAsStrings()));
